...
- Day 3: BART SDM workflow: predictor selection, model evaluation, troubleshooting
	...
	- Open consult --- instructor input on participant project ideas and questions
...
- `data` --- data sets needed for the worked examples (not including larger files to be downloaded from public repos)
